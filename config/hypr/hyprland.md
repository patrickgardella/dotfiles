...
| Package | Notes |
|---------|-------|
| `ttf-firacode-nerd` or `otf-firacode-nerd` | used in waybar, rofi, foot, swaylock |
| `bibata-modern-cursor-theme` or similar | GTK cursor theme |

```
sudo pacman -S ttf-firacode-nerd bibata-modern-cursor-theme
```
