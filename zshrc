...
if [ -d "$HOME/Documents/projects/codaenv" ]; then
   #alias neo="source ~/Documents/projects/neo/.venv/bin/activate && neo"
   export PATH="~/Documents/projects/codaenv/venv/bin:$PATH"
fi
...
#export PATH=/Users/patrick.gardella/Library/Globant/CodaForCoding/bin:$PATH  ## AUTOGENERATED BY CODA INSTALLER
